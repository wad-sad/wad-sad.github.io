...
function getWebGLContext(e) {
  var r,
    ...
    a = !!i;
  a || (i = e.getContext("webgl", n) || e.getContext("experimental-webgl", n)),
    (t = a
  ...
  var o,
    l,
    u,
    c = a ? i.HALF_FLOAT : r.HALF_FLOAT_OES;
  return (
    (u = a
      ? ((o = getSupportedFormat(i, i.RGBA16F, i.RGBA, c)),
        (l = getSupportedFormat(i, i.RG16F, i.RG, c)),
        getSupportedFormat(i, i.R16F, i.RED, c))
      : ((o = getSupportedFormat(i, i.RGBA, i.RGBA, c)),
        (l = getSupportedFormat(i, i.RGBA, i.RGBA, c)),
        getSupportedFormat(i, i.RGBA, i.RGBA, c))),
    {
      gl: i,
      ext: {
        formatRGBA: o,
      ...
      _createClass(t, [
        {
          key: "setKeywords",
          value: function (e) {
            for (var r = 0, t = 0; t < e.length; t++) r += hashCode(e[t]);
            ...
            if (null == n) {
              ...
              (n = createProgram(this.vertexShader, i)), (this.programs[r] = n);
            }
...
function getUniforms(e) {
  for (
    var r = [], t = gl.getProgramParameter(e, gl.ACTIVE_UNIFORMS), n = 0;
    n < t;
    n++
  ) {
...
function initFramebuffers() {
  ...
  (dye =
    null == dye
      ? createDoubleFBO(r.width, r.height, n.internalFormat, n.format, t, o)
      : resizeDoubleFBO(
          dye,
          r.width,
          r.height,
    ...
    (velocity =
      null == velocity
        ? createDoubleFBO(e.width, e.height, i.internalFormat, i.format, t, o)
        : resizeDoubleFBO(
            velocity,
            e.width,
            e.height,
...
function initBloomFramebuffers() {
  ...
  for (
    var i = (bloomFramebuffers.length = 0);
    i < config.BLOOM_ITERATIONS;
    i++
  ) {
    var a = e.width >> (i + 1),
      o = e.height >> (i + 1);
    if (a < 2 || o < 2) break;
    var l = createFBO(a, o, t.internalFormat, t.format, r, n);
...
function createFBO(e, r, t, n, i, a) {
  ...
  return (
    ...
    gl.clear(gl.COLOR_BUFFER_BIT),
    {
      ...
      attach: function (e) {
        return (
          gl.activeTexture(gl.TEXTURE0 + e), gl.bindTexture(gl.TEXTURE_2D, o), e
        );
      },
    }
  );
}
function createDoubleFBO(e, r, t, n, i, a) {
  var o = createFBO(e, r, t, n, i, a),
    l = createFBO(e, r, t, n, i, a);
  return {
    width: e,
    height: r,
...
function resizeFBO(e, r, t, n, i, a, o) {
  var l = createFBO(r, t, n, i, a, o);
  return (
    copyProgram.bind(),
...
function resizeDoubleFBO(e, r, t, n, i, a, o) {
  return (
    (e.width == r && e.height == t) ||
      ((e.read = resizeFBO(e.read, r, t, n, i, a, o)),
      (e.write = createFBO(r, t, n, i, a, o)),
      (e.width = r),
      (e.height = t),
      (e.texelSizeX = 1 / r),
      (e.texelSizeY = 1 / t)),
...
function createTextureAsync(e) {
  ...
  var t = {
      ...
      attach: function (e) {
        return (
          gl.activeTexture(gl.TEXTURE0 + e), gl.bindTexture(gl.TEXTURE_2D, r), e
        );
      },
    },
    n = new Image();
...
function updateColors(e) {
  config.COLORFUL &&
    1 <= (colorUpdateTimer += e * config.COLOR_UPDATE_SPEED) &&
...
function drawDisplay(e, r, t) {
  if (
    ...
    var n = getTextureScale(ditheringTexture, r, t);
...
function applyBloom(e, r) {
  if (!(bloomFramebuffers.length < 2)) {
    ...
    var n = config.BLOOM_THRESHOLD * config.BLOOM_SOFT_KNEE + 1e-4,
      ...
      a = 2 * n,
      o = 0.25 / n;
    gl.uniform3f(bloomPrefilterProgram.uniforms.curve, i, a, o),
      gl.uniform1f(
...
function HSVtoRGB(e, r, t) {
  ...
  switch (
    ((u = t * (1 - r)),
    (c = t * (1 - (l = 6 * e - (o = Math.floor(6 * e))) * r)),
    (g = t * (1 - (1 - l) * r)),
    o % 6)
  ) {
    case 0:
...
function normalizeColor(e) {
  return { r: e.r / 255, g: e.g / 255, b: e.b / 255 };
}
function wrap(e, r, t) {
  var n = t - r;
...
function getTextureScale(e, r, t) {
  return { x: r / e.width, y: t / e.height };
}
...
window.addEventListener("touchend", function (e) {
  ...
  document.addEventListener("mousedown", function (e) {
    if (!switchPage || !switchPage.switched) {
      var r = scaleByPixelRatio(e.pageX),
        t = scaleByPixelRatio(e.pageY),
        n = pointers.find(function (e) {
          return -1 == e.id;
        });
    ...
    if (!switchPage || !switchPage.switched) {
      ...
      if (r.down)
        updatePointerMoveData(
          r,
          scaleByPixelRatio(e.pageX),
          scaleByPixelRatio(e.pageY)
        );
    }
  }),
      ...
      if (!switchPage || !switchPage.switched) {
        ...
        for (var r = e.targetTouches, t = 0; t < r.length; t++) {
          ...
          if (n.down)
            updatePointerMoveData(
              n,
              scaleByPixelRatio(r[t].pageX),
              scaleByPixelRatio(r[t].pageY)
            );
        }
      }
    },
