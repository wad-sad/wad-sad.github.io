...
var MainManager = function () {
      ...
      $("#bt_back").click(function () {
        switch (x) {
          case 1:
            ...
            break;
          default:
            location.href = "https://github.com/wad-sad/wad-sad.github.io";
        }
      }),
    ...
    var m,
      ...
      g = new (function () {
                  ...
                  l.clear(),
                    ...
                    (n =
                      Math.random() < 0.5
                        ...
                        : (215 * Math.PI) / 180),
                    new TimelineLite()
                      .to(l.scale, 0.4, { x: 1, ease: Power2.easeOut })
                      .to(s.scale, 0.4, { y: 1, ease: Power2.easeOut }, 0.1)
                      .to(
                        r,
                        0.6,
                        { rotation: n, ease: Back.easeOut.config(1.7) },
                        0
                      )
                      ...
                      .to(
                        s.scale,
                        0.3,
                        { y: 0, ease: Power2.easeOut, onComplete: i },
                        0.6
                      );
                })();
              };
        ...
        function L() {
          var n = Math.random();
          return n < 0.03 ? 4473924 : n < 0.18 ? 16777215 : k[X()];
        }
        function X() {
          for (var n = 0; n < 10; n++) {
